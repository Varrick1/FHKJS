...
ServerEvents.tags('item', event => {
  ...
  event.add('touhouorigins:melee_weapons', 'mcdw:axe_axe')
  event.add('touhouorigins:melee_weapons', 'mcdw:Axe_anchor')
  event.add('touhouorigins:melee_weapons', 'mcdw:axe_encrusted_anchor')
  event.add('touhouorigins:melee_weapons', 'mcdw:axe_firebrand')
  event.add('touhouorigins:melee_weapons', 'mcdw:axe_highland')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_backstabber')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_chill_gale_knife')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_dagger')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_fangs_of_frost')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_moon')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_resolute_tempest_knife')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_shear_dagger')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_swift_striker')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_tempest_knife')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_the_beginning')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_the_end')
  event.add('touhouorigins:melee_weapons', 'mcdw:dagger_void_touched_blade')
  event.add('touhouorigins:melee_weapons', 'mcdw:double_axe_cursed')
  event.add('touhouorigins:melee_weapons', 'mcdw:double_axe_double')
  event.add('touhouorigins:melee_weapons', 'mcdw:double_axe_whirlwind')
  event.add('touhouorigins:melee_weapons', 'mcdw:gauntlet_gauntlet')
  event.add('touhouorigins:melee_weapons', 'mcdw:gauntlet_maulers')
  event.add('touhouorigins:melee_weapons', 'mcdw:gauntlet_soul_fists')
  event.add('touhouorigins:melee_weapons', 'mcdw:glaive_cackling_broom')
  event.add('touhouorigins:melee_weapons', 'mcdw:glaive_glaive')
  event.add('touhouorigins:melee_weapons', 'mcdw:glaive_grave_bane')
  event.add('touhouorigins:melee_weapons', 'mcdw:glaive_venom_glaive')
  event.add('touhouorigins:melee_weapons', 'mcdw:hammer_boneclub')
  event.add('touhouorigins:melee_weapons', 'mcdw:hammer_bone_cudgel')
  event.add('touhouorigins:melee_weapons', 'mcdw:hammer_flail')
  event.add('touhouorigins:melee_weapons', 'mcdw:hammer_gravity')
  event.add('touhouorigins:melee_weapons', 'mcdw:hammer_great_hammer')
  event.add('touhouorigins:melee_weapons', 'mcdw:hammer_mace')
  event.add('touhouorigins:melee_weapons', 'mcdw:hammer_stormlander')
  event.add('touhouorigins:melee_weapons', 'mcdw:hammer_suns_grace')
  event.add('touhouorigins:melee_weapons', 'mcdw:pick_howling_pick')
  event.add('touhouorigins:melee_weapons', 'mcdw:pick_hailing_pinnacle')
  event.add('touhouorigins:melee_weapons', 'mcdw:pick_howling_pick')
  event.add('touhouorigins:melee_weapons', 'mcdw:pick_mountaineer_pick')
  event.add('touhouorigins:melee_weapons', 'mcdw:scythe_soul_scythe')
  event.add('touhouorigins:melee_weapons', 'mcdw:scythe_frost_scythe')
  event.add('touhouorigins:melee_weapons', 'mcdw:scythe_jailors_scythe')
  event.add('touhouorigins:melee_weapons', 'mcdw:scythe_skull_scythe')
  event.add('touhouorigins:melee_weapons', 'mcdw:sickle_last_laugh_gold')
  event.add('touhouorigins:melee_weapons', 'mcdw:sickle_last_laugh_silver')
  event.add('touhouorigins:melee_weapons', 'mcdw:sickle_nightmares_bite')
  event.add('touhouorigins:melee_weapons', 'mcdw:sickle_sickle')
  event.add('touhouorigins:melee_weapons', 'mcdw:soul_dagger_eternal_knife')
  event.add('touhouorigins:melee_weapons', 'mcdw:soul_dagger_soul_knife')
  event.add('touhouorigins:melee_weapons', 'mcdw:soul_dagger_truthseeker')
  event.add('touhouorigins:melee_weapons', 'mcdw:spear_fortune')
  event.add('touhouorigins:melee_weapons', 'mcdw:spear_spear')
  event.add('touhouorigins:melee_weapons', 'mcdw:spear_whispering_spear')
  event.add('touhouorigins:melee_weapons', 'mcdw:staff_battlestaff')
  event.add('touhouorigins:melee_weapons', 'mcdw:staff_battlestaff_of_terror')
  event.add('touhouorigins:melee_weapons', 'mcdw:staff_growing_staff')
  event.add('touhouorigins:melee_weapons', 'mcdw:staff_growing_staff')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_beestinger')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_broadsword')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_broken_sawblade')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_claymore')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_coral_blade')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_cutlass')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_dancers_sword')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_dark_katana')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_diamond_sword_var')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_freezing_foil')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_frost_slayer')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_great_axeblade')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_hawkbrand')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_heartstealer')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_iron_sword_var')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_katana')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_masters_katana')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_mechanized_sawblade')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_nameless_blade')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_obsidian_claymore')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_rapier')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_sinister')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_sponge_striker')
  event.add('touhouorigins:melee_weapons', 'mcdw:sword_the_starless_night')
  event.add('touhouorigins:melee_weapons', 'mcdw:whip_whip')
  event.add('touhouorigins:melee_weapons', 'mcdw:whip_vine_whip')
