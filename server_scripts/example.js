...
ServerEvents.tags('item', event => {
  ...
  //dualwieldsies
  event.add('dualwield:dualwieldable', '#true_ending:sword')
  event.add('dualwield:dualwieldable', '#rpg_series:daggers')
  event.add('dualwield:dualwieldable', '#forcemaster_rpg:knuckles')
  event.add('dualwield:dualwieldable', '#rpg_series:daggers')
  event.add('true_ending:sword', 'betterend:thallasium_sword')
  event.add('true_ending:sword', 'betterend:aeternium_sword')
  event.add('true_ending:sword', 'betterend:terminite_sword')
  event.add('true_ending:sword', 'betternether:cincinnasite_sword')
  event.add('true_ending:sword', 'betternether:nether_ruby_sword')
  event.add('true_ending:sword', 'betternether:cincinnasite_sword_diamond')
  event.add('dualwield:dualwieldable', '#rpg_series:sickles')
  event.add('dualwield:dualwieldable', 'basicweapons:wooden_dagger')
  event.add('dualwield:dualwieldable', 'basicweapons:stone_dagger')
  event.add('dualwield:dualwieldable', 'basicweapons:iron_dagger')
  event.add('dualwield:dualwieldable', 'basicweapons:gold_dagger')
  event.add('dualwield:dualwieldable', 'basicweapons:diamond_dagger')
  event.add('dualwield:dualwieldable', 'basicweapons:netherite_dagger')
  event.add('dualwield:dualwieldable', '#minecraft:axes')
  event.remove('dualwield:dualwieldable', 'mcdw:axe_anchor')
  event.remove('dualwield:dualwieldable', 'mcdw:axe_encrusted_anchor')
  event.remove('dualwield:dualwieldable', 'mcdw:sword_mechanized_sawblade')
  event.add('dualwield:dualwieldable', '#bakery:knives')
